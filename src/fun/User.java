...
public class User extends Person {
    ...
    public final static String Password = "1a";
...
public void Show_All_Publications(Book a, Booklet b, Magazine c) {
        int d;
        System.out.println("Press 1 to Show all Booksor 2 to Show all Booklets or 3 to Show all magazines or 4 to Show all Publications");
        d = s.nextInt();
        switch (d) {
            case 1:
                a.Show_All_Books();
    ...
    public void userOperation(Book a, Booklet b, Magazine c) {
        ...
        System.out.println("Press 5 to Show All borrowed_Book");
